...
DefaultTableModel model;
    ...
    String sql= "INSERT INTO turnos (turn_cel, turn_ape, turn_nom, turn_fecha, turn_dire, turn_hora, turn_min)VALUES(?,?,?,?,?,?,?)";
        try {
            ...
            psd.setString(2, ape);
            psd.setString(3, nom);
            psd.setString(4, hora);
            psd.setString(5, minu);
            psd.setString(6, fecha);
            psd.setString(7, dire);
    ...
    private void tablaTurnosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaTurnosMouseClicked
        ...
        if(fila>=0){
            ...
            campoHora.setText(tablaTurnos.getValueAt(fila,3).toString());
            campoMin.setText(tablaTurnos.getValueAt(fila,4).toString());
            campoFecha.setText(tablaTurnos.getValueAt(fila,5).toString());
            campoDire.setText(tablaTurnos.getValueAt(fila,6).toString());
        }        
